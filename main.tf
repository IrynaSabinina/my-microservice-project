...
module "s3_backend" {
  ...
  bucket_name = "irynasabinina-terraform-state-lesson-6"
...
module "eks" {
  ...
  cluster_name    = "lesson-6-eks-cluster"
  cluster_version = "1.28"
  
  vpc_id     = module.vpc.vpc_id
  subnet_ids = concat(module.vpc.private_subnet_ids, module.vpc.public_subnet_ids)
  
  node_group_name         = "lesson-6-nodes"
